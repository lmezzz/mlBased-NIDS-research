...
def _run(train_path, test_path, cicids_path, feature_cols, exp_name):
    ...
    # ── PHASE 1 ──
    print(f"\n[RF] {exp_name} — Phase 1 (within-dataset):")
    ...
    # ── PHASE 2 ──
    print(f"\n[RF] {exp_name} — Phase 2 (cross-dataset):")
